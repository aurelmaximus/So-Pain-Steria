...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 28 fév. 2023 à 11:38
...
('basic', 13, 'Canelé', '1.60', 0, 'Viennoiserie', NULL, NULL, NULL),
...
('basic', 15, 'Baguette Tradition', '1.20', 1, 'Pain', NULL, 'Une baguette aux saveurs riches, ancrée dans notre savoir-faire.<br>', 'BaguetteTradition.jpeg'),
...
('basic', 19, 'Baguette Sésame', '1.80', 1, 'Pain', NULL, 'Combinaison parfaite de la saveur subtile des graines de sésame et d\'une mie moelleuse et légère. Avec son extérieur croustillant et son goût unique, notre pain sésame apportera une touche de raffinement à tous vos sandwichs et plats.', 'sesame.jpg'),
...
('basic', 21, 'Pain aux noix', '3.00', 1, 'Pain', NULL, 'Que vous le dégustiez nature, grillé ou accompagné d\'un fromage fin, ce pain artisanal aux noix saura vous combler à chaque bouchée.', 'graines.jpg'),
